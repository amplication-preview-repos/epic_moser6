...
@InputType()
class DeliveryCreateNestedManyWithoutSuppliersInput {
...
export { DeliveryCreateNestedManyWithoutSuppliersInput as DeliveryCreateNestedManyWithoutSuppliersInput };
