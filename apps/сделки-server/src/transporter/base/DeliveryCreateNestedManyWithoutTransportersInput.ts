...
@InputType()
class DeliveryCreateNestedManyWithoutTransportersInput {
...
export { DeliveryCreateNestedManyWithoutTransportersInput as DeliveryCreateNestedManyWithoutTransportersInput };
